...
public class DiffRatioExcel {
    ...
    public static void createExcel() {
        ...
        // 创建一个sheet
        HSSFSheet sheet = doc.createSheet("年度调整文件格式_非统一比例单位公积金");
        // 设置表格列宽
        for (int i = 0; i < 10; i++) {
...
//        style1.setDataFormat(format.getFormat("@"));
        ...
        cell = row.createCell(0);
        cell.setCellStyle(style3);
        cell.setCellValue("资金性质：10一般住房公积金");
        ...
        cell.setCellStyle(style2);
        cell.setCellValue("");
        region = new CellRangeAddress(3, 3, 4, 9);
        sheet.addMergedRegion(region);
        setBorder(BorderStyle.THIN, region, sheet);
        ...
        region = new CellRangeAddress(4, 4, 5, 6);
        sheet.addMergedRegion(region);
        setBorder(BorderStyle.THIN, region, sheet);
        ...
        region = new CellRangeAddress(4, 4, 7, 9);
        sheet.addMergedRegion(region);
        setBorder(BorderStyle.THIN, region, sheet);
        ...
        cell = row.createCell(7);
        cell.setCellStyle(style4);
        cell.setCellFormula("ROUND(E7*(F7/100),0)");

        cell = row.createCell(8);
        cell.setCellStyle(style4);
        cell.setCellFormula("ROUND(E7*(G7/100),0)");

        cell = row.createCell(9);
        cell.setCellStyle(style4);
        cell.setCellFormula("H7+I7");
        ...
        cell = row.createCell(6);
        cell.setCellStyle(style10);
        cell.setCellFormula("F8");

        cell = row.createCell(7);
        cell.setCellStyle(style10);
        cell.setCellFormula("ROUND(E8*(F8/100),0)");

        cell = row.createCell(8);
        cell.setCellStyle(style10);
        cell.setCellFormula("ROUND(E8*(G8/100),0)");

        cell = row.createCell(9);
        cell.setCellStyle(style10);
        cell.setCellFormula("H8+I8");
        ...
        try {
            fos = new FileOutputStream("/Users/Baltan/Desktop/年度调整文件格式_非统一比例单位公积金.xls");
            doc.write(fos);
        } catch (IOException e) {
